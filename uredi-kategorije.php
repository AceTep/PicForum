    ...
    <div class="red">
     ...
     <div class="red">
        ...
        <?php
                ...
                $upit = "SELECT Naziv_Kategorije, Slika_Kategorije, ID_Korisnika FROM kategorija WHERE ID_Kategorije = $ID_Kategorije";
        ...
        <form method="POST" action="uredi-kategorije-spremi.php" enctype="multipart/form-data">
        <input type="hidden" name="ID_Kategorije" value="<?php echo $ID_Kategorije;?>">
            <label for="Naziv_Kategorije">Naziv kategorije*</label>
            <input type="text" name="Naziv_Kategorije" id="Naziv_Kategorije" value="<?php echo $Naziv_Kategorije;?>" required />
            <br><br>
            <label for="Slika_Kategorije">Slika Kategorije*</label>
            <input type="file" name="Slika_Kategorije" id="Slika_Kategorije"><br><br>
            <img src="<?php echo $Slika_Kategorije;?>" alt="<?php echo $Naziv_Kategorije;?>" width="30%" height="20%"><br><br>
            ...
            <select name="ID_Korisnika" id="ID_Korisnika" required>
                <?php 
                    ...
                    $upit = "SELECT ID_Korisnika, Korisničko_ime FROM korisnik WHERE ID_GrupeKorisnika=2 ORDER BY ID_Korisnika = $ID_Korisnika DESC";
                    $rezultat = $baza -> dohvatiDB($upit);
                    while($red = $rezultat ->fetch_array()){
